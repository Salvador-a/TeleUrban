...
document.addEventListener('DOMContentLoaded', function() {
    const formularios = document.querySelectorAll('#formulario-contacto, #formulario-edicion');
    ...
    async function handleFormSubmit(e, formulario, action) {
        e.preventDefault();
        ...
        if (result.error) {
            ...
            if (action === 'crear') {
                confirmTitle = '¿Estás seguro de crear esta cita?';
